//
// Created by Reed Sloan on 2/22/26.
//
...
namespace lve {
    ...
    void LvePipeline::bind(VkCommandBuffer commandBuffer) {
        // we don't need checks because the graphics pipeline must have been properly created at init
    ...
    void LvePipeline::createGraphicsPipeline(const std::string &vertFilePath, const std::string &fragFilePath,
        ...
        // read in the vertex and fragment code
        ...
        if (vkCreateGraphicsPipelines(
                lveDevice.device(), VK_NULL_HANDLE, 1,
    ...
    std::vector<char> LvePipeline::readFile(const std::string &filepath) {
        // ate (seek to end immediately), binary (read in as binary)
        ...
        // tellg gets last position
        size_t fileSize = static_cast<size_t>(file.tellg());
        // character buffer, initialize with size of the file
